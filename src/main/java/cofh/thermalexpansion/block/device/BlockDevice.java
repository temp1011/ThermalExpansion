...
public class BlockDevice extends BlockTEBase implements IModelRegister, IBakeryProvider, IWorldBlockTextureProvider {
	...
	public boolean register() {
		...
		deviceChunkLoader = itemBlock.setDefaultTag(new ItemStack(this, 1, Type.CHUNK_LOADER.getMetadata()));
	...
	public static ItemStack deviceCatcher;
